    ...
    <div class="page">
        ...
        <div class="hero-header">
            <div class="header-content">
                ...
                <div class="header-right">
                    <img src="{{ asset('images/HAPPY BAGS 4X4IN.jpeg') }}" alt="Happy Bags" style="height: 55px; margin-bottom: 8px;">
            ...
            <div class="meta-section">
                <div class="meta-box">
                    ...
                    <div class="meta-row">
                        ...
                        <span class="meta-value">HB-LX-{{ $order->order_id }}</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="notes-section">
            ...
            <div class="notes-content">
                Payment is due within 30 days of invoice date. Please include invoice number on your payment reference. For questions, contact hello@happybags.com
            </div>
        </div>
